    ...
    <div class="container">
        ...
        <div class="main">
            ...
            <form action="index.html" method="post">
                ...
                <div class="name">
                    <input class="fname" type="text" id="name" name="name" placeholder="First name" required>
                    <input class="lname" type="text"  placeholder="Last name" required><br>
                </div>

                <!-- Teacher observed -->
                <div>
                    <label for="dropdown">Teacher Observed :</label>
                    <select class="single-input" id="dropdown" name="cars" placeholder="Select an option" required>
                ...
                <div class="radio-grade grade">
                    <input type="radio" id="grade2" name="grade" value="6">
                    <label for="grade2">6</label>
                    <input type="radio" id="grade3" name="grade" value="7">
                    <label for="grade3">7</label>
                    <input type="radio" id="grade4" name="grade" value="8">
                    <label for="grade4">8</label>
                    <input type="radio" id="grade4" name="grade" value="8">
                    <label for="grade4">9</label>
                    <input type="radio" id="grade4" name="grade" value="8">
                    <label for="grade4">10</label>
                </div><br>
               ...
               <div class="checkbox-class-env class-envv">
                    <input type="checkbox" name="class-env1" class="class-env" id="class-env1" value="Classroom is clean" >
                    <label for="class-env1">Classroom is clean</label><br>
                    <input type="checkbox" name="class-env2" class="class-env"id="class-env2" value="Board Configuration is up-to-date">
                    <label for="class-env2">Board Configuration is up-to-date</label><br>
                    <input type="checkbox" name="class-env3" class="class-env"id="class-env3" value="Standards are posted and visible to all students">
                    <label for="class-env3">Standards are posted and visible to all students</label><br>
                    <input type="checkbox" name="class-env4" class="class-env"id="class-env4" value="Board Configuration is not up-to-date">
                    <label for="class-env4">Board Configuration is not up-to-date</label><br>
                    <input type="checkbox" name="class-env5" class="class-env"id="class-env5" value="Classroom is clean">
                    <label for="class-env5">Classroom is clean</label><br>
                    <input type="checkbox" name="class-env6" class="class-env"id="class-env6" value="Classroom is clean">
                    <label for="class-env6">Classroom is clean</label>
                ...
                <div class="checkbox-highest-level" style="position:relative; bottom:60px; ">
                 ...
                 <div class="checkbox-highest-level high-level"> 
                    <input type="checkbox" name="highest-level1" class="highest-level" id="highest-level1" value="Remembering">
                    <label for="highest-level1">Remembering</label><br>
                    <input type="checkbox" name="highest-level2" class="highest-level" id="highest-level2" value="Understanding">
                    <label for="highest-level2">Understanding</label><br>
                   <input type="checkbox" name="highest-level3" class="highest-level" id="highest-level3" value="Applying">
                    <label for="highest-level3">Applying</label><br>
                    <input type="checkbox" name="highest-level4" class="highest-level" id="highest-level4" value="Analyzing">
                    <label for="highest-level4">Analyzing</label><br>
                    <input type="checkbox" name="highest-level5" class="highest-level" id="highest-level5" value="Evaluating">
                    <label for="highest-level5">Evaluating</label><br>
                    <input type="checkbox" name="highest-level6" class="highest-level" id="highest-level6" value="Creating">
